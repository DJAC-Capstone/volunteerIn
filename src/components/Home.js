      ...
      <div className="main-container">
        <div className="left-container">
          <div className="profileImg-name">
            <img className="image-profile" src={`https://randomuser.me/api/portraits/women/${++i}.jpg`}/>
            <Link to={{
            ...
            return (
              <div key={++i} className="other-users-post-container">
                <div className="profile-pic-and-name-container">
                  <img className="image-friend" src={`https://randomuser.me/api/portraits/women/${i}.jpg`}/>
                  <div>
                    <p>{`${users[friendID].first_name} ${users[friendID].last_name}`}</p>
                  {/* <div>
                    <p className='event-title-homepage'>{`${users[friendID].events[0].title}`}</p>
                    <p className='event-description-homepage'>{`${users[friendID].events[0].description}`}</p>
                  </div> */}
                </div>
                    )
                </div>
